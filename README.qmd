...
[^3]: For part 1, I originally coded up a base `R` version that takes 1.09 min to run (`day23.R` and `day23_functions.R`). Then, I wrote a second version using `igraph` (`day23_v2.R`) which is reported here. 
